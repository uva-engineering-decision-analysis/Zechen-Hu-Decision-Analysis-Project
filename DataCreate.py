...
for day in range(23,30):#30
    f = open("/Users/huzechen/CourseProject/DA/final project/KSCC_201503%d_Incheon.csv"%day)
    data = pd.read_csv(f)
    ...
    dataList = newseries
    dataList.to_csv("/Users/huzechen/CourseProject/DA/final project/result.csv")
